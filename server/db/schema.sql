...
-- opt-in: notify the owner the moment a new software version lands on their car.
ALTER TABLE users ADD COLUMN IF NOT EXISTS notify_on_update BOOLEAN NOT NULL DEFAULT false;
