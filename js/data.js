...
const WEN = (function () {
  ...
  const regions = {
    ...
    "Australia": { osLagDays: 12, drive: "RHD", fsd: {
      AI4: { current: "v13.2.9", next: "v14.x", mode: "paused", fleetPct: 18, pausedSince: "2026-06-23", note: "FSD (Supervised) v14 started reaching AU HW4 cars in June 2026, then Tesla put the rollout on hold (official messaging + widespread owner reports). No committed resume date — including the many new Model Y / Model Y L deliveries still waiting. We've frozen the estimate rather than show a date that no longer holds." },
